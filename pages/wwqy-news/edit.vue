...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      submitForm(value) {
		  value.content = editor.tex.html();//点击提交修改内容
        // 使用 clientDB 提交数据
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("title,avatar,author,content,view_count,is_essence,publish_date,article_status").get().then((res) => {
